...
def AAARetinaNet(num_classes, n_head, attention_type, shot_mode, num_way=2, num_shot=5, pos_encoding=True, pretrained=False):
    """Constructs a ResNet-50 model.
    Args:
    """
    model = aaa_retinanet(num_classes, Bottleneck, [3, 4, 6, 3], n_head=n_head, attention_type=attention_type, 
